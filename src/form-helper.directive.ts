import {
    ...
    OnInit,
    OnDestroy,
    ContentChildren, DoCheck, KeyValueDiffers, KeyValueDiffer, HostListener, AfterViewInit
} from '@angular/core';
...
export class FormHelperDirective implements OnInit, AfterViewInit, OnDestroy, DoCheck {
    ...
    static submitHandlerMap = new Map();
    static errorHandlerMap = new Map();
    ...
    constructor(private renderer: Renderer2,
        ...
        //    this.renderer.addClass(form.nativeElement, this._config.theme);
        //}

        this.mutationObserver = new MutationObserver(() => this.bindSubmitButtons());
        this.mutationObserver.observe(form.nativeElement, {
            childList: true,
            subtree: true
        });
    ...
    private bindSubmitButtons() {
        this.$form.find(':submit').each(btn => {
